...
@app.post("/convert-binary-to-ascii/")
async def convert_binary_to_ascii(request: Request):
    try:
        ...
        converter = BinaryToAsciiConverter()
        ascii_result = converter.convert(binary_data)
